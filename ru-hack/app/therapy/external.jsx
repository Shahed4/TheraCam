...
export default function ExternalRotation() {
    console.log("Loaded");
    return (
        <div style={{position:"absolute", height: "100%", width:"100%", backgroundColor:"lightBlue"}}>
            <h1 style={{
                  margin: "10px auto", 
            ...
            style={{ 
                ...
                <div style={{padding: "10px", border:"2px solid black"}}>
                    ...
                    <img 
                        src={"/assets/image/Standing_External_Rotation_with_Resistance_Band.gif"} 
                        alt="Standing External Rotation" 
                        style={{ width: "400px", height: "200px", marginLeft: "auto", marginRight: "auto" }} 
                    />
                </div>  
                <div style={{padding: "10px", border:"2px solid black"}}>
                ...
                <div style={{
                    ...
                    <div style={{
                        ...
                        <ol>
                            <li style={{fontSize:"20px"}}>Make a 3-foot-long loop with the elastic band and tie the ends together.
                            Attach the loop to a doorknob or other stable object.</li>
                            <li style={{fontSize:"20px"}}>Stand holding the band with your elbow bent and at your side, as
                            shown in the start position.</li>
                            <li style={{fontSize:"20px"}}>Keeping your elbow close to your side, slowly rotate your arm outward.</li>
                            <li style={{fontSize:"20px"}}>Slowly return to the start position and repeat.</li>
                        </ol>
                    </div>
                </div>
